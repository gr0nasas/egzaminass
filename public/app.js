...
var key = 'e4db3ced';
var searchButton = document.getElementById('searchAgain');
searchButton.addEventListener("click", showMovies);

function showMovies() {
  var search = document.getElementById("search").value;
  fetch("".concat(apiUrl).concat(search, "&apikey=").concat(key)).then(function (res) {
    return res.json();
  });
  console.log(data).then(function (data) {
    data.results.forEach(function (element) {
      ...
      text.innerHTML = "".concat(element.title);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpastokodas"] = self["webpackChunkpastokodas"] || [];
